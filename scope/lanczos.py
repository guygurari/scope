'''
Lanczos algorithm as implemented in SciPy/ARPACK, but without the need
...
def eigsh(n, dtype, matvec, k=6, which='LM', v0=None,
    ...
    Minv_matvec = None
    sigma = None
    params = _SymmetricArpackParams(n, k, np.dtype(dtype).char, matvec, mode,
